...
function SignUpContact() {
    ...
    if (!email) {
        ...
        if (emailPattern.test(email)) {
            // If valid email, show the Thank You message
            thankYouMessage.style.display = 'block';

            // Set a timer to hide the "Thank You" message after 3 seconds (3000 milliseconds)
            setTimeout(function() {
                thankYouMessage.style.display = 'none';
                
                // Clear the email input after showing the "Thank You" message
                emailInput.value = ''; // This will clear the email input field
